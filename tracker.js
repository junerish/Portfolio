(function(){
  var EP = window.PORTFOLIO_ANALYTICS_ENDPOINT || (function(){
    ...
    if (s && s.indexOf('AKfycbxkYqQVIFUj94LvY_L_cfm-SoVL7F2dGuW157ezBzEkrrPnnT8I-BYZLzxdw4ei49Oevg') > -1) { s = null; localStorage.removeItem('pf_endpoint'); }
    return s;
  })() || 'https://script.google.com/macros/s/AKfycbxUQZeTza47oB-GAYb7l7lTqrBEunse0WpW_tTrqplHEGjBe-nAcMPkSvsX4YuoTUob/exec';
  function save(v){
